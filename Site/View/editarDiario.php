<?php
	...
	if(isset($email) && isset($_GET['idDiario'])):
?>
<!DOCTYPE html>
<html lang="pt-br">
	...
	<body>
			...
			<div class="row">
				<div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
					<div class="nav-title-top">
						<h4 class="cdst-left">
							<a class="backpage_glypicon" href="telaInicio.php">
		...
		<div class="container-fluid body_white">
			<div class="row">
				...
				<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
					<form name="editDiaries" id="dForms" action="editarDiario2.php" method="POST">
						<input type="hidden" id="idDiario" name="idDiario" value="<?php echo $_GET["idDiario"]; ?>">
						<input type="hidden" id="regimeAntigo" name="regimeAntigo">
						...
						<span class="glyphicon big_glyphicon glyphicon-education "></span>
						<input type="text" id="classRegimen" name="regime" class="form-control-cdst btn-outline" readonly>
						<!-- <select id="classRegimen" name="regime" class="form-control-cdst btn-outline" readonly>
